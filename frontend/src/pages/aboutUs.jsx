...
function AboutUs() {
  return (
    <main className="h-screen overflow-y-hidden">
      ...
      <div className="h-screen flex justify-center items-center bg-gradient-to-r from-purple-400 to-violet-800">
      <div className="bg-white rounded-lg p-12 absolute left-12 right-12 shadow-lg">
